...
public class ArrCharOps {
    ...
    */
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        ...
        char[] charSubArray = new char[nSubArrayLength];

        int iCurrSubArrayIndex = 0;
        for (int i = beginIndex; i <endIndex; i++, iCurrSubArrayIndex++)
        {
            charSubArray[iCurrSubArrayIndex] =   arr[i];
        }
        return charSubArray;
    }
